...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers("/api/auth/**", "/h2-console/**", "/api/upload/**", "/api/conpot/**", "/api/honeypot/**", "/api/decoy/**", "/api/deception/**", "/api/threat-intel/**", "/api/cases", "/api/cases/**", "/api/assistant/**", "/api/research/**", "/pcap/**", "/ws/**", "/pcap/interfaces", "/pcap/pcap-interfaces")
            .permitAll()
